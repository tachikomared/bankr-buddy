...
// ── IPC ───────────────────────────────────────────────────────────────────────
ipcMain.on('enable-mouse',  () => { console.log('enable-mouse'); mainWindow?.setIgnoreMouseEvents(false); });
ipcMain.on('disable-mouse', () => { console.log('disable-mouse'); mainWindow?.setIgnoreMouseEvents(true, { forward: true }); });
